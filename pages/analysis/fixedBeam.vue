                    ...
                    <v-card-text class="text-xs-center pa-0 ma-0">
                        <v-stage :config="{width:width, height:height}">
                            <v-layer ref="layer">
                                ...
                                <konva-rect :xo="0.07*width" :yo="0.475*height" :width="0.03*width" :height="0.05*width"></konva-rect>
        ...
        computed:{
            ...
            Mi(){
                ...
                _.forEach(this.Lx(), (x,i) =>{
                    Mx = this.w*(6*this.L*x - Math.pow(this.L,2) - 6*Math.pow(x,2))/12
                    _.forEach(this.PL, (Pi,j)=>{
                        let a = Pi.a
                        let b = this.L - a
                        let P = Pi.P
                        if(x <= a){
                            Mx =  Mx + P*Math.pow(b,2)*(3*a+b)*x/Math.pow(this.L,3) - P*a*Math.pow(b,2)/Math.pow(this.L,2)
                        }//IF
                        else{
                            Mx =  Mx + P*Math.pow(b,2)*(3*a+b)*x/Math.pow(this.L,3) - P*a*Math.pow(b,2)/Math.pow(this.L,2) - P*(x-a)
                        }//ELSE
                    })//P LOOP
                    M.push(Mx)
                })
            ...
            Vi(){
                ...
                _.forEach(this.Lx(), (x,i) =>{
                    ...
                    _.forEach(this.PL, (Pi,j)=>{
                        ...
                        let P = Pi.P
                        if(x <= a){
                            Vx =  Vx + P*Math.pow(b,2)*(3*a+b)/Math.pow(this.L,3)
                        }//IF
                        else{
                            Vx =  Vx + P*Math.pow(b,2)*(3*a+b)/Math.pow(this.L,3) - P
                        }//ELSE
                    })//P LOOP
                    V.push(Vx)
                })//X LOOP
            ...
            Di(){
                ...
                _.forEach(this.Lx(), (x,i) =>{
                    Dx = this.w*Math.pow(x,2)/(24*this.E*this.Ix())*1728*(Math.pow(this.L -x,2))
                    _.forEach(this.PL, (Pi,j)=>{
                        let a = Pi.a
                        let b = this.L - a
                        let P = Pi.P
                        if(x <= a){
                            Dx =  Dx + (P*Math.pow(b,2)*Math.pow(x,2)*1728)/(12*this.E*this.Ix()*Math.pow(this.L,3))*(3*a*this.L-3*a*x-b*x)
                            //Dx =  Dx + (P*1728)/(6*this.E*this.Ix())*(Math.pow(b,2)*Math.pow(x,3)*(2*this.L+a)/(2*Math.pow(this.L,3)) - 3*a*Math.pow(b,2)*x/(2*this.L))
                        }//IF
                        else{
                            ...
                            Dx =  Dx + (P*1728)/(6*this.E*this.Ix())*(Math.pow(b,2)*Math.pow(x,3)*(2*this.L+a)/(2*Math.pow(this.L,3)) - 3*a*Math.pow(b,2)*x/(2*this.L)-Math.pow(x-a,3))
                        }//ELSE
                    })//P LOOP
                    D.push(Dx)
                })//X LOOP
