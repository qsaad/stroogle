...
<script>
    import ConcreteWall from '@/classes/concrete/clsConcreteWall'
    ...
    export default {
        ...
        computed:{
            calculate(){
                ...
                let CW = new ConcreteWall(inputData)


                this.messages = [
                    {status : CW.Ast() < CW.Asmin(), type : 'warning', title: '', value : 'As < As min'},
                ]
        
                this.fMn = CW.flexuralCapacity()
