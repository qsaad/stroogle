            ...
            <v-flex xs6 md4>
                <v-card hover height="100%">
                    <v-card-text class="text-xs-center pa-3">
                        <v-layout row wrap>
                            <v-flex xs12>
                                <v-img src="../images/analysis/analysis-simplebeam.svg" max-width=200 ></v-img>
                            </v-flex>
                        </v-layout>
                    </v-card-text>
                </v-card>
                        ...
                        <v-card hover>
                            <v-card-text class="text-xs-center">
                                <v-layout row wrap>
                                    ...
                                    <v-flex xs12 md6>
                                        <value-computed  title="R" subscript="DL" :value="RDL"  :decimal=2 unit="k" tooltip="DL Reaction"></value-computed>
                                    </v-flex>
                                    <v-flex xs12 md6>
                                        <value-computed  title="R" subscript="LL" :value="RLL"  :decimal=2 unit="k" tooltip="LL Reaction"></value-computed>
                                    </v-flex>
                                     <v-flex xs12> 
        ...
        computed:{
            ...
            design(){
               ...
               //CAPACITIES
                ...
                this.Vr = (this.DLF*this.DL + this.LLF*this.LL)*this.L/2
                this.RDL = (this.DLF*this.DL)*this.L/2
                this.RLL = (this.LLF*this.LL)*this.L/2
