            ...
            <v-flex xs6 md3>
                <v-card hover height="100%">
                    <v-card-text class="text-xs-center pa-3">
                        ...
                        <v-text-field label="Radius (ft)" v-model="radius" class="pa-0 ma-0"></v-text-field> 
     ...
     middleware: ['auth'],
        ...
        computed:{
            ...
            design(){
                ...
                this.tensionParams = GL.tensionParams()
                this.shearParams = GL.shearParams() 
                this.axialParams = GL.axialParams()
                this.bearingParams = GL.bearingParams()

                //this.adjustmentFactors = []
                this.adjustmentFactors = GL.adjustmentFactors()
            }//Design
        },//COMPUTED
        methods:{
