        ...
        data(){
            return{
                items : [
                    ...
                    {title : 'Address', description:'',  completed : false},
                    {title : 'Subject', description:'Magnitude and Direction',  completed : false},
                    {title : 'Purpose', description:'',  completed : false},
                    {title : 'Body', description:'',  completed : false},
                    {title : 'Conclusion', description:'',  completed : false},
                    {title : 'Signature', description:'',  completed : false},
                ]
            }//RETURN
        },//DATA
        head(){
