        ...
        data(){
            return{
                items : [
                    ...
                    {title : 'Codes', description:'', completed : false},
                    {title : 'Materials', description:'Magnitude and Direction',  completed : false},
                    {title : 'Loads', description:'',  completed : false},
                    {title : 'Foundation System', description:'',  completed : false},
                    {title : 'Floor Framing System', description:'',  completed : false},
                    {title : 'Roof Framing System', description:'',  completed : false},
                    {title : 'Lateral Force Resisting system', description:'',  completed : false},
                    {title : 'Special Requirements', description:'',  completed : false},
                ]
            }//RETURN
        },//DATA
        head(){
